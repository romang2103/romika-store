...
/**
 * Handles loading and rendering of a single product
 * based on the `id` query param in the URL.
 */
  ...
  if (!product) {
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        ...
        <Button onClick={() => router.push("/")} className="mt-4 bg-primary hover:bg-primary-700">
...
/**
 * This wrapper ensures the product page is safely rendered with Suspense
 * to avoid issues with `useSearchParams()` during prerendering.
 */
